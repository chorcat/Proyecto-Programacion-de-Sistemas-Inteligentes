...
public class HandEvaluator {
    ...
    private void calculateHighCard() {
        ...
        hsValue = getChenScore(cards_temp);
        System.out.println("hsValue HIGH CARD = " + hsValue);
    }
        ...
        if (noOfPairs == 1) {
            ...
            for(Card card : cards) {
                if(card.getRank() == pairRank) {
                    cards_temp[0] = card;
                } else if(card.getRank() == rankings[2]) {
                    cards_temp[1] = card;
                }
            }
            hsValue = getChenScore(cards_temp);
            System.out.println("hsValue ONE_PAIR = " + hsValue);
            return true;
        } else {
            return false;
        }
    ...
    private boolean isTwoPairs() {
        if (noOfPairs == 2) {
            ...
            Card[] cards_temp_high = new Card[2];
            for(Card card : cards) {
                if(card.getRank() == highRank) {
                    cards_temp_high[0] = card;
                } else if(card.getRank() == rankings[3]) {
                    cards_temp_high[1] = card;
                }
            }
            Card[] cards_temp_low = new Card[2];
            for(Card card : cards) {
                if(card.getRank() == lowRank) {
                    cards_temp_low[0] = card;
                } else if(card.getRank() == rankings[3]) {
                    cards_temp_low[1] = card;
                }
            }
            double hsValue_high = getChenScore(cards_temp_high);
            double hsValue_low = getChenScore(cards_temp_low);
            hsValue = (hsValue_high + hsValue_low) / 2;
            System.out.println("hsValue TWO_PAIRS = " + hsValue);
            return true;
        } else {
            return false;
        }
    ...
    private boolean isThreeOfAKind() {
        if (tripleRank != -1) {
            ...
            hsValue = getChenScore(cards_temp);
            System.out.println("hsValue THREE_OF_A_KIND = " + hsValue);
            return true;
        } else {
            return false;
        }
    ...
    private boolean isStraight() {
        if (straightRank != -1) {
            ...
            hsValue = straightRank;
            System.out.println("hsValue STRAIGHT = " + hsValue);
            return true;
        } else {
            return false;
        }
    ...
    private boolean isFlush() {
        if (flushSuit != -1) {
            ...
            hsValue = flushRank;
            System.out.println("hsValue FLUSH = " + hsValue);
            return true;
        } else {
            return false;
        }
    ...
    private boolean isFullHouse() {
        if ((tripleRank != -1) && (noOfPairs > 0)) {
            ...
            double hsValue_low = getChenScore(cards_temp_low);
            hsValue = (hsValue_high + hsValue_low) / 2;
            System.out.println("hsValue FULL HOUSE = " + hsValue);
            return true;
        } else {
            return false;
        }
    ...
    private boolean isFourOfAKind() {
        if (quadRank != -1) {
            ...
            hsValue = getChenScore(cards_temp);
            System.out.println("hsValue FOUR_OF_A_KIND = " + hsValue);
            return true;
        } else {
            return false;
        }
        ...
        if (straightRank != -1 && flushRank == straightRank) {
            ...
            if (inStraight >= 5 && inFlush >= 5) {
                if (straightRank == Card.ACE) {
                    ...
                    rankings[0] = type.getValue();
                    hsValue = 0.0;
                    System.out.println("hsValue ROYAL_FLUSH = " + hsValue);
                    return true;
                } else {
                    // Straight Flush.
                    ...
                    hsValue = straightRank2;
                    System.out.println("hsValue STRAIGHT_FLUSH = " + hsValue);
                    return true;
                }
