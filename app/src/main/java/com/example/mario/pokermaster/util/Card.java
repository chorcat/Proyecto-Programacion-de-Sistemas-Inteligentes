...
public class Card implements Comparable<Card> {
    ...
    /** The rank symbols. */
    public static final String[] RANK_SYMBOLS_LETRA = {
    ...
    public static final String[] SUIT_SYMBOLS_LETRA = { "diamonds", "clubs", "hearts", "spades" };
    ...
    public String toString2() {
        return RANK_SYMBOLS_LETRA[rank] +"_of_"+ SUIT_SYMBOLS_LETRA[suit];
    }
